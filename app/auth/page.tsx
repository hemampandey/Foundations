        ...
        <div className="relative z-10 space-y-8 my-auto">
          <div className="space-y-4 animate-fade-in stagger-2">
            <h1 className="text-4xl font-extrabold font-display leading-[1.15] text-white tracking-tight">
              ...
              <span className="bg-gradient-to-r from-primary via-indigo-400 to-violet-400 bg-clip-text text-transparent">Counselling Theories</span>
            </h1>
            <p className="text-sm text-muted-foreground leading-relaxed max-w-md">A premium, spacing-optimized training platform designed to concrete conceptual foundations and decision making.</p>
          </div>
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-6 py-12 sm:px-12 lg:px-20 relative">
        ...
        <div className="w-full max-w-sm space-y-8 relative z-10">
          ...
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left space-y-3 animate-scale-in stagger-2">
            ...
            <h2 className="text-2xl font-bold font-display text-foreground tracking-tight">{activeTab === 'login' ? 'Sign in to Foundations' : 'Create your account'}</h2>
          ...
          <div className="border border-border bg-card rounded-2xl p-6 shadow-xl shadow-primary/5 space-y-6 glass-card animate-scale-in stagger-3">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                {activeTab === 'signup' && (
                  <p className="text-[9px] text-muted-foreground/80 leading-snug">Minimum {MIN_PASSWORD_LENGTH} characters.</p>
                )}
              </div>
            ...
            <button
              ...
              className="w-full py-2.5 px-4 rounded-xl font-bold bg-card text-foreground hover:bg-secondary border border-border transition-all flex items-center justify-center gap-2 cursor-pointer text-xs">
